...
const Navbaar = () => {
    ...
    const logoutuser = async () => {
        ...
        if (!res2.status === 201) {
            ...
            history("https://amazonservice-0j2o.onrender.com/");
        }
    }
            ...
            <nav>
                <div className="left">
                    ...
                    <div className="navlogo">
                        <NavLink to="https://amazonservice-0j2o.onrender.com/"> <img src="./amazon_PNG25.png" alt="logo" /> </NavLink>
                    </div>
                            ...
                            <List className="extrasearch" hidden={liopen}>
                                {
                                    products.filter(product => product.title.longTitle.toLowerCase().includes(text.toLowerCase()))?.map(product => (
                                        <ListItem>
                                            <NavLink to={`https://amazonservice-0j2o.onrender.com/getproductsone/${product.id}`} onClick={() => setLiopen(true)}>
                ...
                <div className="right">
                    ...
                    {
                        account ? <NavLink to="https://amazonservice-0j2o.onrender.com/buynow">
                        ...
                        </NavLink> : <NavLink to="https://amazonservice-0j2o.onrender.com/login">
                            <div className="cart_btn">
